...
class ProfileTypeCRUDTest extends ProfileTestBase {
  ...
  public function testUi() {
    ...
    $this->assertSession()->addressEquals('admin/config/people/profiles/types/add');
    ...
    $this->assertSession()->addressEquals('admin/config/people/profiles/types');
    $this->assertSession()->responseContains(new FormattableMarkup('%label profile type has been created.', ['%label' => $label]));
    $this->assertSession()->linkByHrefExists("admin/config/people/profiles/types/manage/$id");
    $this->assertSession()->linkByHrefExists("admin/config/people/profiles/types/manage/$id/fields");
    $this->assertSession()->linkByHrefExists("admin/config/people/profiles/types/manage/$id/display");
    $this->assertSession()->linkByHrefExists("admin/config/people/profiles/types/manage/$id/delete");
    ...
    $profile->save();
    $this->drupalGet("admin/config/people/profiles/types/manage/$id/delete");
    ...
    $this->assertSession()->linkByHrefExists('admin/config/people/profiles/types');
